...
public class ATMInterface {
    ...
    private void performTransfer() {
        ...
        private boolean validateRecipientAccount(String recipientAccountNumber) {
            ...
            validRecipientAccounts.add("017022100000001");
            validRecipientAccounts.add("017022100000002");
            validRecipientAccounts.add("017022100000003");
            validRecipientAccounts.add("017022100000004");
            validRecipientAccounts.add("017022100000005");
